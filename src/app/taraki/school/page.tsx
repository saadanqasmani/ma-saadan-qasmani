...
import { Pane } from "@/components/taraki/Pane";
  ...
  return (
    <>
      ...
      <main className="tk-shell" style={{ paddingBlock: "clamp(3rem, 7vw, 5rem) 6rem" }}>
        ...
        <p className="tk-lead tk-rise" style={{ marginTop: "1.25rem", maxWidth: "62ch", animationDelay: "0.1s" }}>
        ...
        <section style={{ marginTop: "3.5rem" }}>
          <h2 className="tk-h2">What we do for you</h2>
        ...
        <section style={{ marginTop: "4rem" }}>
          <h2 className="tk-h2">What your school still has to do</h2>
          <p className="tk-body" style={{ marginTop: "0.75rem", maxWidth: "58ch" }}>
        ...
        <p className="tk-small" style={{ marginTop: "3rem", maxWidth: "62ch" }}>
