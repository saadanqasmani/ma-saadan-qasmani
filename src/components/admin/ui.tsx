...
export const buttonClass =
  "t-label inline-flex items-center justify-center gap-2 border border-ink bg-ink px-5 py-2.5 text-canvas-light transition-opacity hover:opacity-85 disabled:opacity-50";

export const ghostButtonClass =
  "t-label inline-flex items-center justify-center gap-2 border border-line px-5 py-2.5 text-ink-soft transition-colors hover:border-ink hover:text-ink";
...
export function StatusBadge({ value }: { value: string }) {
  ...
  return (
    <span
      className={cn(
        "t-label inline-block whitespace-nowrap border px-2 py-1",
        tone
      )}
    >
