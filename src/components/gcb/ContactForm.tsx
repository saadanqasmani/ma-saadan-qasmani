...
export function ContactForm() {
  ...
  if (sent) {
    return (
      <div className="gcb-pane gcb-land" style={{ padding: "1.75rem" }}>
        <p className="gcb-h2" style={{ fontSize: "1.125rem" }}>Not sent, and here is the honest reason.</p>
  ...
  return (
    ...
    >
      ...
      <div style={{ marginTop: "1.5rem" }}>
        <label className="gcb-label" style={{ color: "var(--text-faint)" }} htmlFor="c-name">
          Your name
        </label>
      ...
      <div style={{ marginTop: "1.25rem" }}>
        <label className="gcb-label" style={{ color: "var(--text-faint)" }} htmlFor="c-email">
          Email
        </label>
      ...
      <div style={{ marginTop: "1.25rem" }}>
        <label className="gcb-label" style={{ color: "var(--text-faint)" }} htmlFor="c-msg">
          Message
        </label>
        <textarea id="c-msg" name="message" required rows={5} style={{ ...field, resize: "vertical" }} />
      </div>

      <button type="submit" className="gcb-btn gcb-btn--primary" style={{ marginTop: "1.75rem", width: "100%", justifyContent: "center" }}>
        Send
      </button>

      <p className="gcb-small" style={{ marginTop: "1rem" }}>
