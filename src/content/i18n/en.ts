...
export const en = {
  ...
  journal: {
    ...
    gate: {
      ...
      body: "Notes from the archive, arguments still forming, and the occasional piece that belongs to neither the research nor the fiction. Leave your address and an access code is emailed to you; enter it here and the page stays open on this browser for a year.",
      subscribe: "Subscribe",
      emailPlaceholder: "you@example.com",
      enter: "Enter",
      unlocksNote: "The code arrives by email. If it is not in your inbox, look under Promotions.",
      sent: "Check your email. The code is on its way, and it may land under Promotions. Type it into the other box to come in.",
      sentNoEmail: "You are on the list, but the email could not go out just now. Write to me and I will send the code by hand.",
