...
export const de: DictionaryOverlay = {
  ...
  journal: {
    ...
    gate: {
      ...
      body: "Notizen aus dem Archiv, Argumente, die noch entstehen, und gelegentlich ein Stück, das weder zur Forschung noch zur Fiktion gehört. Hinterlassen Sie Ihre Adresse, und ein Zugangscode wird Ihnen zugeschickt; geben Sie ihn hier ein, und die Seite bleibt in diesem Browser ein Jahr lang offen.",
      subscribe: "Abonnieren",
      emailPlaceholder: "sie@beispiel.de",
      enter: "Eintreten",
      unlocksNote: "Der Code kommt per E-Mail. Sehen Sie unter Werbung nach, falls er nicht im Posteingang ist.",
      sent: "Sehen Sie in Ihre E-Mails. Der Code ist unterwegs und landet möglicherweise unter Werbung. Tragen Sie ihn in das andere Feld ein.",
      sentNoEmail: "Sie stehen auf der Liste, aber die E-Mail konnte gerade nicht versendet werden. Schreiben Sie mir, und ich schicke den Code von Hand.",
