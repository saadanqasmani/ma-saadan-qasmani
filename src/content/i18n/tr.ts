...
export const tr: DictionaryOverlay = {
  ...
  journal: {
    ...
    gate: {
      ...
      body: "Arşivden notlar, henüz kurulmakta olan savlar ve arada bir ne araştırmaya ne kurmacaya ait olan bir yazı. Adresinizi bırakın, erişim kodunuz e-postayla gelsin; kodu buraya girdiğinizde sayfa bu tarayıcıda bir yıl boyunca açık kalır.",
      subscribe: "Abone ol",
      emailPlaceholder: "siz@ornek.com",
      enter: "Girin",
      unlocksNote: "Kod e-postayla gelir. Gelen kutunuzda yoksa Tanıtımlar sekmesine bakın.",
      sent: "E-postanıza bakın. Kod yolda; Tanıtımlar sekmesine düşebilir. Diğer kutuya yazıp girin.",
      sentNoEmail: "Listedesiniz ama e-posta şu anda gönderilemedi. Bana yazın, kodu elden göndereyim.",
  ...
  novel: {
    ...
    form: "Biçim",
    status: "Durum",
    availability: "Ön sipariş",
    orderACopy: "Kitabınızı ayırtın",
    ...
    purchase: {
      ...
      amazonPending: "Amazon'da henüz yok. Yayımlanmadan önce orada olacak; {regions} okurları için satış oradan yapılacak.",
      preOrderNote: "şimdi ön sipariş",
      preOrderEyebrow: "Ön sipariş · Türkiye ve Pakistan",
      shipsOn: "Yayımlandığında gönderilir, {date}",
      encourage:
        "Kitap şu anda Türkiye ve Pakistan için basılıyor; kaç adet basılacağını ön siparişler belirliyor. Bir adet ayırtın, ciltlendiği hafta yola çıksın.",
      fewer: "Bir adet azalt",
      more: "Bir adet artır",
      perCopy: "adedi",
      promoLabel: "Promosyon kodu",
      promoPlaceholder: "Varsa yazın",
      apply: "Uygula",
      promoOk: "%{percent} indirim uygulandı.",
      promoBad: "Bu kod bize ait değil.",
      subtotalLine: "{n} × {each}",
      discountLine: "Promosyon kodu (%{percent} indirim)",
      total: "Toplam",
      yourDetails: "Nereye gönderilsin",
      payByCard: "Ön sipariş — {total} öde",
      reserveInstead: "Ya da ayırtın, ödemeyi elden yapın",
      reserve: "Kitabımı ayırt",
      payNote:
        "Kart bilgileri Stripe'ın kendi sayfasında alınır. Hiçbiri bu siteden geçmez, hiçbiri burada saklanmaz.",
      reserveNote:
        "Burada ödeme alınmaz. Kitabınız ayrılır, ödeme bilgileri e-postayla iletilir.",
      paidTitle: "Kitabınız sizin.",
      paidBody:
        "Ödeme alındı; makbuzunuz Stripe'tan geliyor. Kitap, baskıdan çıktığı hafta size yola çıkar.",
      reservedTitle: "Kitabınız ayrıldı.",
      reservedBody:
        "Hiçbir tahsilat yapılmadı. Ödeme bilgileri e-postayla ulaşacak; kitap baskıdan çıktığı hafta yola çıkar.",
      cancelledBody: "Ödeme tamamlanmadı. Hiçbir tahsilat yapılmadı, bilgileriniz duruyor.",
      notifyLabel: "Amazon'da çıkınca haber ver",
      notify: "Haber ver",
      notifyNote:
        "Bu, çalışmalarım hakkında gönderdiğim kısa mektubun aynısı. İlan yayına girdiğinde tek satır; istediğiniz an ayrılabilirsiniz.",
      notifyDone: "Not aldım. Yayına girdiği gün haberiniz olacak.",
    },
  },
